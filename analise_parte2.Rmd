...
dataset_datas_alteradas <- dataset_sem_CT_e_imagens %>%
  dplyr::mutate(data_reuniao = dplyr::case_when(
    nome_arquivo == "ata-3-reuniao-extraordinaria.doc" & comite == "Baixada Santista" ~ lubridate::as_date("2013-12-10"),
    
        nome_arquivo == "ata-da-2-reuniao-extraordinaria.docx" & comite == "Baixada Santista" ~ lubridate::as_date("2013-10-15"),
    
        nome_arquivo == "ata-plenaria-06-10-2006.doc" & comite == "Litoral Norte" ~ lubridate::as_date("2006-10-06"),   
    
            nome_arquivo == "ata-reuniao-19-de-maio-revisada.doc" & comite == "Litoral Norte" ~ lubridate::as_date("2006-05-19"),   
    
            nome_arquivo == "7-ext_comitespcj_16-12-11.pdf" & comite == "Piracicaba / Capivari / Jundiaí" ~ lubridate::as_date("2011-12-16"),       
            nome_arquivo == "cbhata04805.htm" & comite == "Ribeira do Iguape e Litoral Sul" ~ lubridate::as_date("2005-10-14"),    
    
                nome_arquivo == "cbhata066_11.pdf" & comite == "Ribeira do Iguape e Litoral Sul" ~ lubridate::as_date("2011-02-25"),    
    
                    nome_arquivo == "cbhata070_12.doc" & comite == "Ribeira do Iguape e Litoral Sul" ~ lubridate::as_date("2012-04-13"),  
    
                        nome_arquivo == "cbhata069_12.doc" & comite == "Ribeira do Iguape e Litoral Sul" ~ lubridate::as_date("2012-02-15"),  
...
# inconsistencias nas datas de reunião em baixada santista,  litoral norte, ribeira do iguape
```

REMOVER AINDA: ATAS RESUMIDAS, 2 REUNIOES NA MESMA DATA
...
dataset_sem_duplicatas <- dataset_datas_alteradas %>%
  ...
  dplyr::filter(data_reuniao == "2015-12-09", data_postagem ==  "2016-06-22")
...
dataset_sem_duplicatas %>% 
  ...
  dplyr::filter(n != 1
               , comite == "Ribeira do Iguape e Litoral Sul"
                )

#Feitos: AT, LN, PCJ

# FALTA: BS, DANDO MÓ TRABALHO PQ TEM VÁRIAS REUNIOES COM DATA ERRADA
```
