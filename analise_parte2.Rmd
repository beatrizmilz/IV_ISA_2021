...
# inconsistencias nas datas de reunião em baixada santista,  litoral norte, ribeira do iguape, SMT
```
...
dataset_sem_duplicatas %>%
  ...
  dplyr::filter(n != 1
                , comite == "Piracicaba / Capivari / Jundiaí")

#Feitos: AT, LN, PCJ, RB,mogi, SMT

# FALTA: BS, DANDO MÓ TRABALHO PQ TEM VÁRIAS REUNIOES COM DATA ERRADA,  REVER PCJ
```
