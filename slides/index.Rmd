...
tibble::tibble(objective = as.character(),
  ...
  tibble::add_row(
    ...
    conclusions = "Data from the plemuns minutes need to be more complete: There were ZERO plenums minutes available for Paraíba do Sul, and there is no plenums minutes available for Sorocaba and Médio Tietê during the water crisis."
  ) %>%
  tibble::add_row(objective = "2) Considering the plenum’s minutes encountered, we also aim to identify the most discussed subjects in plenary sessions using text mining methods.",
                  ...
                  next_steps = "Study the corpus with computer assisted qualitative data analysis software (CAQDAS) *[1]") %>% 
  gt::gt() %>% 
  gt::cols_label(
...
.footnote[[1] Not in the scope of the ongoing research.]
