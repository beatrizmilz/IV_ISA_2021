...
5) Fixed the dataset in order to have 1 file of minute per plenum. Examples: 
...
6) Read the files for the minutes in the resulted dataset (656 files), into a new dataset with a column with the content of the minute. 
